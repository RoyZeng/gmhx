...
<script type="text/javascript">
	$(function() {
		...
		$('#userOrgId').combobox('disable');   //不可用
	});
	
	function submitForm(){
		if(validateForm()){
			$.post("${ctx}/personalSetting/updatePerson",$('#form').serialize(),
					function(msg){
		...
		<form id="form" method="post">
			...
			<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse;">
				<tr>
					...
					<td width="25%"><input id="userName" name="userName" type="text" disabled="disabled" placeholder="请输入用户名" value="${user.userName}"></td>
					<td width="25%" align="center">登录名</td>
					<td width="25%"><input id="userLoginName" name="userLoginName" disabled="disabled" type="text" placeholder="请输入登录名" value="${user.userLoginName}" ></td>
				</tr>
				<tr>
					<td width="25%" align="center">所属机构</td>
					<td width="25%"><input id="userOrgId" name="userOrgId" type="text" placeholder="请输入所属机构" editable="false" class="easyui-combobox" class="span2" value="${user.userOrgId}" data-options="url:'${ctx}/hxCode/getOrgCombobox'"></td>
				...
				<tr>
                    ...
                    <td width="25%"><input name="userSex" id="userSex" type="text" placeholder="请输入性别" editable="false" class="easyui-combobox" 
                                        data-options="url:'${ctx}/hxCode/getCombobox/xb?value=${user.userSex}'"></td>
				</tr>
				<tr>
					<td width="25%" align="center">学历</td>
                    <td width="25%"><input id = "userEducation" name="userEducation" type="text" placeholder="请输入学历" class="easyui-combobox" editable="false" 
                                        data-options="url:'${ctx}/hxCode/getCombobox/xl?value=${user.userEducation}'"/></td>
					<td width="25%" align="center">籍贯</td>
					<td width="25%"><input id="userOrigin" name="userOrigin" type="text" placeholder="请输入籍贯" value="${user.userOrgId}"></td>
				</tr>
				<tr>
				...
				<tr>
                    ...
                    <td width="25%" colspan="3"><input id="userAddress" name="userAddress" type="text" placeholder="请输入地址" value="${user.userAddress}"></td>
                </tr>
				<tr>
