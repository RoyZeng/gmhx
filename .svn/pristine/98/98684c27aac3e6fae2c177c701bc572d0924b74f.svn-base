...
<script type="text/javascript">
	...
	function checkTicket(serviceId){
		window.location.href = "${ctx}/installProject/installProjectQueryShow/"+serviceId;
	}
	...
	function exportExcel(){
		...
		window.location.href = "${ctx}/installProject/exportExcel?" + encodeURI($('#searchForm').serialize()) + "&tableField=" + fieldArray.join("|") + "&tableHeader=" + encodeURI(encodeURI(titleArray.join("|")));
    }
