...
<script type="text/javascript">
	$(function() {
		...
		var isLeafNode = $("#isLeafNode").val();
		$("input[name='isLeafNodeButton']").each(function(){ 
            if($(this).val()==isLeafNode){ 
	...
	function submitForm(){
	  if(validateForm()){
		$.post("${ctx}/hxMenu/updateMenu",$('#form').serialize(),
		function(msg){
		...
		<form id="form" method="post">
			...
			<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse;">
				<tr>
					...
					<td width="25%"><input id="menuId" name="menuId" type="hidden" value="${menu.menuId}"><input id="menuName" name="menuName" type="text" placeholder="请输入菜单名称" value="${menu.menuName}"></td>
					<td width="25%" align="center">菜单路径</td>
					<td width="25%"><input id="url" name="url" type="text" placeholder="请输入菜单路径" value="${menu.url}"></td>
				</tr>
				<tr>
					<td width="25%" align="center">菜单图标位置</td>
					<td width="25%"><input id="iconUrl" name="iconUrl" type="text" placeholder="请输入菜单图标位置" value="${menu.iconUrl}"></td>
					<td width="25%" align="center">序号<font color="red">*</font></td>
					<td width="25%"><input id="sort" name="sort" type="text" placeholder="请输入序号" value="${menu.sort}"></td>
				</tr>
				<tr>
					<td width="25%" align="center">父菜单<font color="red">*</font></td>
					<td width="25%"><input id="parentId" name="parentId" type="hidden" value="${menu.parentId}"><input id="parentName" name="parentName" type="text" onFocus="chooseParent();" placeholder="请选择父菜单" value="${menu.parentName}" readonly></td>
					<td width="25%" align="center">是否叶子节点<font color="red">*</font></td>
					<td width="25%"><input id="isLeafNode" name="isLeafNode" type="hidden" value="${menu.isLeafNode}"/><input name="isLeafNodeButton" type="radio" value="1" checked >是</input><input name="isLeafNodeButton" type="radio" value="0">否</input></td>
					
				</tr>
				<tr>
					<td width="25%" align="center">菜单描述</td>
					<td width="25%" colspan="3"><textarea id="menuDesc" name="menuDesc" placeholder="请输入菜单描述" rows="3" cols="52" >${menu.menuDesc}</textarea></td>
				</tr>
			</table>
	</form>
