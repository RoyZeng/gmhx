...
<script type="text/javascript">
	...
	$(function() {
		dataGrid = $('#dataGrid').datagrid({
			title : "邮包收发货历史",
			url : "${ctx}/hxMaterialHistory/getHxParcelPageList",
			striped : true,
			...
			columns : [ [{
				...
				field : 'trantransportation_expenses',
				title : '运输费用',
				width : 20,
				align:'center',
				sortable : true
...
// 		var pageMarkup = "list"; //页面标记位
// 		window.location.href="${ctx}/hxParcelReceipt/showParcelView/"+ parcelCode ;
// 	}
	function show(parcelCode){
	...
	function exportExcel(){
		...
		for(var i = 1; i < opts.length ;i++){//第一个操作不要
