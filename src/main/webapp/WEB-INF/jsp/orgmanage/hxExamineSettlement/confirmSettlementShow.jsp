...
<div style="text-align:right;padding:5px">
	<form id="form" method="post">
		<div
			style="background-color: #95b8e7; text-align: left; color: #fff; font-weight: bold; border-bottom: 1px solid #000;">结算单确认</div>
		<table border=1 style="cellSpacing: 1; cellPadding: 3; width: 100%; background-color: #eff5ff; border-collapse: collapse">
			<tr>
				<td width="30%" align="center">同意确认：</td>
				<td width="70%" align="center">
					<input type="radio" checked="checked" name="approveComment" value="1">是&nbsp;&nbsp;
					<input type="radio" name="approveComment" value="0">否
				</td>
			</tr>
			<tr>
				<td width="30%" align="center">确认说明：</td>
				<td width="70%" align="left"><textarea name="comment" id="comment" rows="1" cols="140"></textarea></td>
			</tr>
			<tr>
				<td colspan="2" align="center">
					<a href="javascript:void(0);" class="easyui-linkbutton" onclick="comfirm();">提交</a>
				</td>
			</tr>
		</table>
	</form>
