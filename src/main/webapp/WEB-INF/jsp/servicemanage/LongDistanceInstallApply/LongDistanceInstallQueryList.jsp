...
<script type="text/javascript">
	...
	function checkTicket(applyId){
		window.location.href="${ctx}/longDistanceInstallApply/longDistanceInstallQueryShow/"+ applyId ;
	}
	...
	function exportExcel(){
		...
		window.location.href = "${ctx}/longDistanceInstallApply/exportExcel?" + encodeURI($('#searchForm').serialize()) + "&tableField=" + fieldArray.join("|") + "&tableHeader=" + encodeURI(encodeURI(titleArray.join("|")));
    }
