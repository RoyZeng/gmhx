...
<script type="text/javascript">
	...
	function check(serviceId){
		window.location.href = "${ctx}/serviceTicketCheck/serviceTicketCheckView/${map.service_id}";
	}
...
<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse">
	...
	<tr>	
		...
		<td width="25%"><input class="easyui-combobox" disabled="disabled" data-options="url:'${ctx}/hxCode/getCombobox/shjg?value=${map.check_result}',editable:false"/></td>
...
<div style="text-align:right;padding:5px">
    	<a href="#" class="easyui-linkbutton"  onclick="check();">审核</a>
