...
<script type="text/javascript">
	...
	function update(){
		...
		window.location.href="${ctx}/installReceipt/updateInstallReceiptView/"+ serviceId;
	}
	...
	function affirm(){
		$.messager.confirm("", "确认后不允许修改？", function (data) {
    		if(data){
    			var serviceId = $("#service_id").val();
				$.post("${ctx}/installReceipt/affirmInstallReceipt/"+ serviceId,
						function(msg){
...
<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse">
	...
	<tr>
		...
		<td width="25%" >
		<input disabled="disabled" type="text" class="easyui-combobox" data-options="url:'${ctx}/hxCode/getRegionCombobox',panelHeight:'200', editable:true,required:true" value="${map.province}">
		</td>
...
<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse">
	...
	<tr>
		...
		<td width="25%" >
			<input disabled="disabled" type="text" class="easyui-combobox" data-options="url:'${ctx}/hxCode/getECCombobox',required:true" value="${map.sale_center }">
		</td>
	</tr>
	<tr>
		<td width="25%" align="center">销售门店</td>
		<td width="25%" >
			<input disabled="disabled" type="text" class="easyui-combobox" data-options="url:'${ctx}/hxCode/getStoreCombobox',required:true" value="${map.sale_market }">
		</td>
	...
	<tr>
		...
		<td width="25%" >
			<input disabled="disabled" type="text" data-options="url:'${ctx}/hxCode/getRegionCombobox',panelHeight:'200', editable:true,required:true" value="${map.install_province }" class="easyui-combobox">
		</td>
	</tr>
	<tr>
...
<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse">
	...
	<tr>	
		...
		<td width="25%" >
			<input class="easyui-combobox" disabled="disabled" data-options="url:'${ctx}/hxCode/getCombobox/myd?value=${map.service_satisfaction}', editable:false"/>
		</td>
	...
	<tr>	
		...
		<input class="easyui-combobox" disabled="disabled" value="${map.quality_significance}" data-options="url:'${ctx}/hxCode/getCombobox/zyx', editable:false"/></td>
	</tr>
	<tr>	
