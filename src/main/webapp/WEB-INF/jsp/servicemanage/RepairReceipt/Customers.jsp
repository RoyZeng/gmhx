...
<script type="text/javascript">
	$(function() {
		...
		var msg='${list}';
		if(msg){
			var jsons = $.parseJSON(msg.replace(/(\n)+|(\r\n)+/g,""));
			$("#checkedUser").html("");
	...
	function selectCustomer(installNum) {
		$("tbody tr").css("background",'#FFFFFF');
		$("#"+installNum).css("background",'#C0C0C0');
		$("#checkedId").val(installNum);
	}
</script>
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="" style="overflow: scroll;">
		<input type="hidden" id="checkedId" name="azd01" value="">
