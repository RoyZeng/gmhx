...
<script type="text/javascript">
    ...
    function onStart(heigh){
        dataGrid = $('#dataGrid').datagrid({
            ...
            columns : [ [ 
              {field : 'service_id',title :'服务单号',width : 40,align:'center',sortable:true
            ...
            },{field : 'machine_check_fault_reason',title : '机审无<br/>效原因',width : 14,align:'center'
            ...
            },{field : 'create_time_s',title : '创建<br/>时间',width : 10,align:'center',sortable:true
...
<body>
    <div class="easyui-layout" data-options="fit:true,border:false">
        <div data-options="region:'north',title:'查询条件',border:false,collapsible:true,onBeforeCollapse:function(){clos();},onExpand:function(){ope();}"  style="height: 260px; overflow: hidden;">
            <form id="searchForm">
            	<table style="width:100%; padding: 10px 10px 10px 10px;">
                    <tr>
                        ...
                        <td width="8%">机型:</td><td width="12%"><input class="easyui-combobox" data-options="url:'${ctx}/hxCode/getModelCombobox?type=&category=R',panelHeight:'100',editable:true"/></td>
                    ...
                    <tr>
                 	...
                 	<tr>
                        <td>安装省份:</td><td><input name="serviceProduct.installProvince" class="easyui-combobox" data-options="url:'${ctx}/hxCode/getRegionCombobox',hasDownArrow:false,panelHeight:'200', editable:true,mode:'remote'"/></td>
                        ...
                        <td>接收分部:</td><td><input name="serviceTicket.center" class="easyui-combobox" data-options="url:'${ctx}/hxCode/getAftermarketCombobox',hasDownArrow:false"/></td>
                    <tr>
                   	</tr>
                    ...
                    <tr>
            			<td width="8%">安装日期:</td>
                       	<td width="12%">
                        	<input id="azks" style="width:38%" placeholder="起始日期"  name="mod_installDate_st" type="text" readonly="readonly" onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'azjs\')}'})"/>-
							<input id="azjs" style="width:38%"  placeholder="结束日期"  name="mod_installDate_end" type="text" readonly="readonly" onFocus="WdatePicker({minDate:'#F{$dp.$D(\'azks\')||\'%y-%M-%d\'}'})"/> 
                       	</td>
                       	<td width="8%">销售日期:</td>
                        <td width="12%">
                        	<input id="xsks" style="width:38%"  placeholder="起始日期"  name="mod_saleDate_st" type="text" readonly="readonly" onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'xsjs\')}'})"/>-
							<input id="xsjs" style="width:38%"  placeholder="结束日期"  name="mod_saleDate_end" type="text" readonly="readonly" onFocus="WdatePicker({minDate:'#F{$dp.$D(\'xsks\')||\'%y-%M-%d\'}'})"/>
                        </td>
                        <td width="8%">服务日期:</td>
                        <td width="12%">
                        	<input id="fwks" style="width:38%"  placeholder="起始日期"  name="mod_serviceDate_st" type="text" readonly="readonly" onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'fwjs\')}'})"/>-
							<input id="fwjs" style="width:38%"  placeholder="结束日期"  name="mod_serviceDate_end" type="text" readonly="readonly" onFocus="WdatePicker({minDate:'#F{$dp.$D(\'fwks\')||\'%y-%M-%d\'}'})"/>
                        </td>
                        <!-- <td width="8%">审核时间:</td>
                        <td width="12%">
                       		<input id="shks" style="width:38%"  placeholder="起始时间"  name="mod_checkDate_st" type="text" readonly="readonly" onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'shjs\')}'})"/>-
							<input id="shjs" style="width:38%"  placeholder="结束时间"  name="mod_checkDate_end" type="text" readonly="readonly" onFocus="WdatePicker({minDate:'#F{$dp.$D(\'shks\')||\'%y-%M-%d\'}'})"/>
                        </td> -->
                        <td width="8%">创建日期:</td>
                        <td width="12%">
