...
<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse">
	...
	<tr>	
		<td width="25%" align="center">录单时间</td><td width="25%" ><label><fmt:formatDate value='${sr.recordTime}' pattern='yyyy-MM-dd HH:mm:ss' /></label></td>
	...
	<tr>	
		...
		<td width="25%" align="center">分部审批日期</td><td width="25%" ><label><fmt:formatDate value='${sr.centerCheckTime}' pattern='yyyy-MM-dd' /></label></td>
	</tr>
	<tr>	
	...
	<tr>	
		...
		<td width="25%" align="center">总部审批日期</td><td width="25%" ><label><fmt:formatDate value='${sr.headquartersCheckTime}' pattern='yyyy-MM-dd' /></label></td>
	</tr>
	<tr>	
