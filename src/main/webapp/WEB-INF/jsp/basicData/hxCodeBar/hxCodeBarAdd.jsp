...
<script type="text/javascript">
	$(function() {
		...
		$(":text:gt(0):lt(3)").attr("disabled","disabled");
		$('#compareType').combobox({    
		    url:'${ctx}/hxCode/getCombobox/dzlx',
		    editable:false,
		...
		$('#innerModel1, #innerModel2, #outerModel').combobox({    
...
<form id="form" method="post">
	<table class="table table-hover table-condensed" style="padding: 10px 20px 10px 20px;">
		<tr>
			...
			<td width="25%"><input name="innerCode1" type="text" placeholder="请输入内机代码1"></td>
		</tr>
		<tr>
			<td width="25%" align="center">内机代码2</td>
			<td width="25%"><input name="innerCode2" type="text" placeholder="请输入内机代码2"></td>
			<td width="25%" align="center">外机代码</td>
			<td width="25%"><input name="outerCode" type="text" placeholder="请输入外机代码"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="25%"><input name="codeBegin" type="text" placeholder="请输入代码起始位"></td>
			<td width="25%" align="center">品牌</td>
		    <td width="25%"><input class="easyui-combobox" name="brand"  class="span2" data-options="url:'${ctx}/hxCode/getCombobox/pp'"/></td>
		</tr>
		<tr>
