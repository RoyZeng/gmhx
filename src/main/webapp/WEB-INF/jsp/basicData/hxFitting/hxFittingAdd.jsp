...
<script type="text/javascript">
	...
	function save(flag){
		...
		$.ajax({ 
            type:"POST", 
            url:"${ctx}/hxFitting/addHxFitting", 
            dataType:"json",      
            contentType:"application/json",               
            data:JSON.stringify(hxFitting), 
            success:function(data){
            	if(data.flag == "success"){
	            	$.messager.alert('','新增成功!',null,function(){
	            		if(flag == "continue"){
...
<form id="form" method="post">
	...
	<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse">
		...
		<tr>
			...
			<td width="25%"><input class="easyui-combobox" name="fittingType" id="fittingType"/></td>
		</tr>
		<tr>
			<td width="25%" align="center">配件编码<font color="red">*</font></td>
			<td width="25%"><input name="fittingCode" type="text" placeholder="请输入配件编码"></td>
			<td width="25%" align="center">配件名称<font color="red">*</font></td>
			<td width="25%"><input name="fittingName" type="text" placeholder="请输入配件名称"></td>
		</tr>
		<tr>
			<td width="25%" align="center">部品号</td>
			<td width="25%"><input name="partsCode" type="text" placeholder="请输入部品号"></td>
			<td width="25%" align="center">规格</td>
			<td width="25%"><input name="spec" type="text" placeholder="请输入规格"></td>
		</tr>
		<tr>
			<td width="25%" align="center">生产类型</td>
			<td width="25%"><input class="easyui-combobox" name="produceType" data-options="url:'${ctx}/hxCode/getCombobox/sclx', editable:false"/></td>
			<td width="25%" align="center">配件级别</td>
			<td width="25%"><input class="easyui-combobox" name="fittingLevel" data-options="url:'${ctx}/hxCode/getCombobox/pjjb', editable:false"/></td>
		</tr>
		<tr>
		    <td width="25%" align="center">品牌<font color="red">*</font></td>
		    <td width="25%"><input class="easyui-combobox" name="brand"   data-options="url:'${ctx}/hxCode/getCombobox/pp', editable:false"/></td>
			<td width="25%" align="center">国美代码<font color="red">*</font></td>
			<td width="25%"><input class="easyui-combobox" name="gomeCode" data-options="url:'${ctx}/hxCode/getCombobox/gmdm', editable:false"/></td>
		</tr>
		<tr>
			<td width="25%" align="center">成本价格<font color="red">*</font></td>
			<td width="25%"><input name="cost" type="text" placeholder="请输入成本价格"></td>
			<td width="25%" align="center">分部价格<font color="red">*</font></td>
			<td width="25%"><input name="branchPrice" type="text" placeholder="请输入分部价格"></td>
		</tr>
		<tr>
			<td width="25%" align="center">网点价格<font color="red">*</font></td>
			<td width="25%"><input name="networkPrice" type="text" placeholder="请输入网点价格"></td>
			<td width="25%" align="center">用户价格<font color="red">*</font></td>
			<td width="25%"><input name="userPrice" type="text" placeholder="请输入用户价格"></td>
		</tr>
		<tr>
			<td width="25%" align="center">是否回收</td>
			<td width="25%"><input class="easyui-combobox" name="isRetrieve" data-options="url:'${ctx}/hxCode/getCombobox/sf', editable:false"/></td>
			<td width="25%" align="center">是否停用</td>
			<td width="25%"><input class="easyui-combobox" name="isStop" data-options="url:'${ctx}/hxCode/getCombobox/sf', editable:false"/></td>
		</tr>
		<tr>
			<td width="25%" align="center">保修期限</td>
			<td width="25%"><input name="term" type="text" placeholder="请输入保修期限"></td>
			<td width="25%" align="center">备注</td>
			<td width="25%"><textarea name="comment" placeholder="请输入备注" rows="3" cols="52"></textarea></td>
		</tr>
