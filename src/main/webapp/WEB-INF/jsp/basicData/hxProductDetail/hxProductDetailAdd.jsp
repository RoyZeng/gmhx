...
<form id="form" method="post">
	...
	<table class="table table-hover table-condensed" style="padding: 10px 20px 10px 20px;">
		...
		<tr>
			...
			<td width="25%"><input class="easyui-combobox" id="classifyCode" name="classifyCode" class="span2"/></td>
		</tr>
		<tr>
			...
			<td width="25%"><input name="matnr" type="text" placeholder="请输入角色名称" class="easyui-validatebox span2" data-options="required:true"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="25%" ><textarea name="comment" placeholder="请输入备注"></textarea></td>
		</tr>
	</table>
</form>